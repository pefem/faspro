window.addEventListener("DOMContentLoaded", function (evt) {
    ...
    if (page.getElementsByAttribute("artisan-obj", "hdr")) {

        var layout_hdr = page.getElementsByAttribute("artisan-obj", "hdr")[0];
        ...
        stars.map(function (star) {
            ...
            star.addEventListener("mousedown", function (evt) {
                if (evt.button == 0) {
                    ...
                    //var owner_txt = rating_frm.getElementByAttribute("name", "owner_txt");
                    ////
                    //owner_txt.value = "878960897687";
                    //fname_txt.value = "Campilax";
                    //lname_txt.value = "Dum";
                    //email_txt.value = "baiwekhoe@yahoo.com";
                    ////
                    //rating_frm.submit();
                }
            });
