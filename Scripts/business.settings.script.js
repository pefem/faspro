window.addEventListener("DOMContentLoaded", function (evt) {
    ...
    var page_body = this.document.body,
        ...
        services_pnl = page.getElementByAttribute("mode", "edq"),
    ...
    if (profile_pnl != null) {
        var avatar_upld_btn = profile_pnl.getElementByAttribute("id", "profilephotoupldr")
                                         .getElementByAttribute("upload-button").getElementsByTagName("input")[0];
        avatar_upld_btn.addEventListener("change", function (evt) {
            if (this.files.length > 0) {
                ...
                var txtAboutCompany = document.getElementById("txtAboutCompany");
                ...
                var txtCompanyBgImg = document.getElementById("txtCompanyBgImg");

                document.getElementById("tmpTxtCompanyName").value = txtCompanyName.value;
                document.getElementById("tmpTxtAboutCompany").value = txtAboutCompany.value;
                document.getElementById("tmpCmbCategory").value = cmbCategory.options[cmbCategory.selectedIndex].value;
                document.getElementById("tmpTxtPhoneNo").value = txtPhoneNo.value;
                document.getElementById("tmpTxtWebsite").value = txtWebsite.value;
                document.getElementById("tmpTxtCompanyBgImg").value = txtCompanyBgImg.value;
                
                upldFrm.submit();

                //console.log(document.getElementById("tmpTxtCompanyBgImg").value);
            }
        });

        var cover_upld_btn = profile_pnl.getElementByAttribute("id", "coverphotoupldr")
                                        .getElementByAttribute("upload-button").getElementsByTagName("input")[0];
        cover_upld_btn.addEventListener("change", function (evt) {
            if (this.files.length > 0) {
                var upldFrm = profile_pnl.getElementByAttribute("id", "coverphotoupldr");
                ...
                var txtPhoneNo = document.getElementById("txtPhoneNo");
                var txtWebsite = document.getElementById("txtWebsite");
                var txtCompanyAvatrImg = document.getElementById("txtCompanyAvatrImg");

                document.getElementById("ctmpTxtCompanyName").value = txtCompanyName.value;
                document.getElementById("ctmpTxtAboutCompany").value = txtAboutCompany.value;
                document.getElementById("ctmpCmbCategory").value = cmbCategory.options[cmbCategory.selectedIndex].value;
                document.getElementById("ctmpTxtPhoneNo").value = txtPhoneNo.value;
                document.getElementById("ctmpTxtWebsite").value = txtWebsite.value;
                document.getElementById("ctmpTxtCompanyAvatrImg").value = txtCompanyAvatrImg.value;

                upldFrm.submit();

                //console.log(document.getElementById("ctmpTxtCompanyName").value);
            }
        });
    ...
    if (services_pnl != null) {
        var gridvw = services_pnl.getElementByAttribute("bdy-obj", "grdvw");
        if (gridvw) {
            var gridvw_itms = gridvw.getElementsByAttribute("grdvw-obj", "rw");
            if (gridvw_itms) {
                gridvw_itms.map(function (itm) {
                    ...
                    remove_btn.addEventListener("click", function (evt) {
                        ...
                        var cfrm = new confirmbox();
                        cfrm.show({
                            text: 'Are you sure you want to delete this service? (Y/N)',
                            yes: function (param) {
                        ...
                        renew_btn.addEventListener("click", function (evt) {
                            ...
                            xhr({
                                ...
                                onready: function (param) {
                                    ...
                                    document.location.href = "?p=viewinvoice&pckge=" + response.package + "&invoice=" + response.invoice;
                                }
                            });
