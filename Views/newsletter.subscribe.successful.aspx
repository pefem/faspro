<%@ Page Language="C#" MasterPageFile="Shared/ContentReaderPage.Master" AutoEventWireup="true" CodeBehind="newsletter.subscribe.successful.aspx.cs" Inherits="FindAService_WebForm.Views.newsletter_subscribe_successful" %>
    ...
    <div layout-obj="reader-headr" style="border:none; padding:20px;">
        <div headr-obj="hdr" style="padding:0px;">
            <div hdr-obj="lft-pane" style="width:700px; padding:0px;">
                ...
                <div pane-obj="description">You have successfully subscribed to our newsletter listing.</div>
            </div>
        </div>
    </div>
</asp:Content>
