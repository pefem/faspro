<%@ Page Language="C#" MasterPageFile="Shared/Page404.Master" AutoEventWireup="true" CodeBehind="page404.choosepassword.aspx.cs" Inherits="FindAService_WebForm.Views.page404_choose_password" %>
    ...
    <div layout-obj="reader-headr" style="border:none; padding:20px;">
        <div headr-obj="hdr" style="padding:0px;">
            <div hdr-obj="lft-pane" style="width:700px; padding:0px;">
                <div pane-obj="title">Choose a Password!</div>
            </div>
        </div>
    </div>
</asp:Content>
