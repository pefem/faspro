<%@ Page Title="" Language="C#" MasterPageFile="Shared/IndividualPage.Master" AutoEventWireup="true" CodeBehind="business.account.portfolio.aspx.cs" Inherits="FindAService_WebForm.business" %>
...
<asp:Content ID="main_body_lft" ContentPlaceHolderID="main_body_lft" runat="server">
    <%
        ...
        if (user != null)
        {
            ...
            var user_service = db.Services.Find(user.BusinessCategory_ID);
    %>
        ...
        <div coporate-obj="bdy">
            ...
            var numOfUnseenRequst = notifCntrllr.GetRecentBusinessNotificationCount(new FindAService_WebForm.UserBusiness
            {
                ...
                RegistrationDate = user.RegistrationDate
                    ...
                    <div tab-obj="btn" class="portfolio" form="iform" selected="true"><span><a href="?p=account&tb=1&u=<% Response.Write(Request["u"]); %>">Portfolio</a></span></div>
