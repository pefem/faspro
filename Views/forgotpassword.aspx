<%@ Page Title="" Language="C#" MasterPageFile="Shared/AuthPage.Master" AutoEventWireup="true" CodeBehind="forgotpassword.aspx.cs" Inherits="FindAService_WebForm.Login" %>
    ...
    <div layout-obj="login">
        <div login-obj="tab">
            <ul style="width:300px;">
                <li selected="true" style="width:250px;"><span label="1">Forgot Password</span></li>
            </ul>
        </div>
        <div login-obj="bdy">
            <div id="information-form" ftype>
                <div bdy-obj="form-layout">
                    <div form-layout-obj="left-pane">
                        <form method="post" action="?p=doforgotpassword" enctype="application/x-www-form-urlencoded">
                            <div bdy-obj="form">
                                <%
                                    if (Session["forgot_error"] == "NOTFOUND")
                                    {
                                %>
                                <div form-obj="row" float="true">
                                    <div row-obj="column"></div>
                                    <div row-obj="column" style="color: rgb(255, 0, 0)">Sorry this email address does not exist.</div>
                                </div>
                                <%
                                    }
                                %>
                                ...
                                <div form-obj="row" float="true">
                                    ...
                                    <div row-obj="column">
                                        <div row-obj="column">
                                            <input type="submit" id="btnSubmit" value="Recover Password" />
                                        </div>
                                    </div>
                                </div>
                            </div>
