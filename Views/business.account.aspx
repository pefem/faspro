<%@ Page Title="" Language="C#" MasterPageFile="Shared/BusinessAccountPage.Master" AutoEventWireup="true" CodeBehind="business.account.aspx.cs" Inherits="FindAService_WebForm.business" %>
...
<asp:Content ID="main_body_lft" ContentPlaceHolderID="main_body_lft" runat="server">
    <%
        ...
        if (user != null)
        {
            ...
            var user_state = db.States.Find(user.State_ID);
            var user_country = db.Countries.Find(user.Country_ID);
            var user_bizcategory = db.BusinessCategories.Find(user.BusinessCategory_ID);
    %>
