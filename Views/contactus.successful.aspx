<%@ Page Language="C#" MasterPageFile="Shared/ContentReaderPage.Master" AutoEventWireup="true" CodeBehind="contactus.successful.aspx.cs" Inherits="FindAService_WebForm.Views.contactus_successful" %>
    ...
    <div layout-obj="reader-headr" style="border:none; padding:20px;">
        <div headr-obj="hdr" style="padding:0px;">
            <div hdr-obj="lft-pane" style="width:700px; padding:0px;">
                <div pane-obj="title">Congratulations!</div>
                <div pane-obj="description">Your request has been successfully sent. A response will be sent to your mailbox as soon as possible.</div>
            </div>
        </div>
    </div>
</asp:Content>
