<%@ Page Language="C#" MasterPageFile="Shared/ContentReaderPage.Master" AutoEventWireup="true" CodeBehind="password.update.success.aspx.cs" Inherits="FindAService_WebForm.Views.password_update_success" %>
    ...
    <div layout-obj="reader-headr" style="border:none;">
        <div headr-obj="hdr">
            <div hdr-obj="lft-pane" style="width:600px;">
                <div pane-obj="title">Password Update Successful!</div>
                <div pane-obj="description">Your existing password has been succesfully updated to a new one.</div>
            </div>
        </div>
    </div>
</asp:Content>
