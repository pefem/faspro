<%@ Page Language="C#" MasterPageFile="Shared/ContentReaderPage.Master" AutoEventWireup="true" CodeBehind="error.aspx.cs" Inherits="FindAService_WebForm.Views.error" %>
    ...
    <div layout-obj="reader-headr" style="border:none; padding:20px;">
        <div headr-obj="hdr" style="padding:0px;">
            <div hdr-obj="lft-pane" style="width:700px; padding:0px;">
                <div pane-obj="title">Error!</div>
                <div pane-obj="description">Sorry, an unexpected error occurred, your request failed to send at this time.
                    <br />
