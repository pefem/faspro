<%@ Page Language="C#" MasterPageFile="Shared/Page404.Master" AutoEventWireup="true" CodeBehind="page404.productkey.aspx.cs" Inherits="FindAService_WebForm.Views.page404_productkey" %>
    ...
    <div layout-obj="reader-headr" style="border:none; padding:20px;">
        <div headr-obj="hdr" style="padding:0px;">
            <div hdr-obj="lft-pane" style="width:700px; padding:0px;">
                <div pane-obj="title">Invalid Product Key!</div>
                <div pane-obj="description">Sorry, activation failed, you gave an invalid product key. Please contact administrator</div>
            </div>
        </div>
    </div>
</asp:Content>
