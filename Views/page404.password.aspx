<%@ Page Language="C#" MasterPageFile="Shared/Page404.Master" AutoEventWireup="true" CodeBehind="page404.password.aspx.cs" Inherits="FindAService_WebForm.Views.page404_password" %>
    ...
    <div layout-obj="reader-headr" style="border:none; padding:20px;">
        <div headr-obj="hdr" style="padding:0px;">
            <div hdr-obj="lft-pane" style="width:700px; padding:0px;">
                <div pane-obj="title">Incorrect Password!</div>
                <div pane-obj="description">Sorry, deactivation failed, you gave an incorrect password. Please contact administrator</div>
            </div>
        </div>
    </div>
</asp:Content>
