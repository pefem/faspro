<%@ Page Title="" Language="C#" MasterPageFile="Shared/IndividualAccountPage.Master" AutoEventWireup="true" CodeBehind="business.account.notification.aspx.cs" Inherits="FindAService_WebForm.business" %>
...
<asp:Content ID="script_area" ContentPlaceHolderID="script_area" runat="server">
    ...
    <script src="/Scripts/business.account.notification.script.js" type="text/javascript"></script>
...
<asp:Content ID="style_area" ContentPlaceHolderID="style_area" runat="server">
    ...
    <link rel="stylesheet" href="Content/css/layouts/layout.business.notification.style.css" type="text/css" />
</asp:Content>
...
<asp:Content ID="main_body_lft" ContentPlaceHolderID="main_body_lft" runat="server">
    ...
    <div layout-obj="coporate">
        ...
        <div coporate-obj="bdy">
            ...
            <div bdy-obj="right-pane">
                <div layout-obj="tab">
                    <%
                        var numOfUnseenRequst = notifCntrllr.GetRecentBusinessNotificationCount(new FindAService_WebForm.UserBusiness
                        {
                            ID = user.ID,
                            Country_ID = user.Country_ID,
                            State_ID = user.State_ID,
                            City_ID = user.City_ID,
                            BusinessCategory_ID = user.BusinessCategory_ID,
                ...
                <div layout-obj="brd">
                    ...
                    <div brd-obj="row" class="comment-lstvw">
                        <div row-obj="cmmnt-lstvw">
                                            ...
                                            <div frm-obj="rw">
                                                ...
                                                <div rw-obj="field-hndl">
                                                    <div field-hndl-obj="field">
                                                        <select style="width: 457px;" name="serv-cmb" p="<% Response.Write(Request["p"]); %>&tb=<% Response.Write(Request["tb"]); %>" u="<% Response.Write(Request["u"]); %>" m="<% Response.Write(Request["m"]); %>" t="<% Response.Write(Request["t"]); %>">
                                                            <%
                                                        if (servces != null)
                                                        {
                                                ...
                                                <div rw-obj="field-hndl">
                                                    <div field-hndl-obj="field">
                                                        <select style="width: 457px;" name="bizcateg-cmb" p="<% Response.Write(Request["p"]); %>&tb=<% Response.Write(Request["tb"]); %>" u="<% Response.Write(Request["u"]); %>" m="<% Response.Write(Request["m"]); %>" t="<% Response.Write(Request["t"]); %>">
                                                            <%
                                ...
                                <%
                                    foreach (var p in results)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            url = "?p=business&s=" + usr_businesscategory.Increment + "&u=" + email;
                                        }
                            ...
                            {
                                var msg = notifCntrllr.GetCompanyNotification(new FindAService_WebForm.UserBusiness
                                {
                                    ID = user.ID,
                                    BusinessCategory_ID = user.BusinessCategory_ID
                                }, int.Parse(Request["i"]));
                                ...
                                else
                                {
                                    ...
                                    if (busr != null)
                                    {
                                        ...
                                        var busr_bizcateg = db.Services.Find(iusr.Service_ID);
                                ...
                                <div readervw-obj="hdr">
                                    <div hdr-obj="pnl">
                                        ...
                                        <div pnl-obj="info">
                                            ...
                                            <div info-obj="buttn">
                                                <div buttn-obj="btn" selected><a href="<% Response.Write(url.ToLower()); %>">Contact <% Response.Write(cntact); %></a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div cmmnt-lstvw-obj="lstvw">
                                <%
                                    var page = 0;
                                    int.TryParse(Request["page"], out page);
                                    var msgs = notifCntrllr.GetCompanyNotifications(new FindAService_WebForm.UserBusiness
                                    {
                                        ID = user.ID,
                                        Country_ID = user.Country_ID,
                                        State_ID = user.State_ID,
                                    ...
                                    {   
                                %>
                                <div lstvw-obj="title">Available Requests:</div>
                                <% 
                                        foreach (var msg in msgs)
                                        {
                                            ...
                                            var email = "";
                                            var url = "";
                                            var count = db.UserJobBoxNotificationStatus.Where(x => (x.User_ID == user.ID || x.User_ID == user.BusinessCategory_ID) && x.Notification_ID == msg.ID && x.Status != (int)FindAService_WebForm.JobBoxNotificationStatus.Read).Count();
                                            ...
                                            else
                                            {
                                                ...
                                                var busr_businesscategory = db.BusinessCategories.Find(busr.BusinessCategory_ID);
                                                url = "?p=business&s=" + busr_businesscategory.Increment + "&u=" + email;
                                            }
                                %>
                                <div lstvw-obj="itm" <% Response.Write(status); %> url="?p=account&tb=<% Response.Write(Request["tb"]); %>&t=<% Response.Write(Request["p"]); %>&u=<% Response.Write(Request["u"]); %>&m=vw&i=<% Response.Write(msg.Increment); %>&<% Response.Write(DateTime.Now.Ticks.ToString("x")); %>">
                                    <div itm-obj="avatar">
                                        <div info-obj="phldr"><i class="fa fa-user"></i></div>
                                        <div info-obj="img" style="background-image: url('?p=avatar&url=<% Response.Write((user != null) ? image : ""); %>')"></div>
                                    </div>
    ...
    <div wnd-obj="choose-locatn-diag">
        <div choose-locatn-diag-obj="chrome">
            <div chrome-obj="hdr">Choose a Location</div>
            <div chrome-obj="bdy">
                <form id="changeloctnfrm_" action="?p=dochangeloctn&r=<% Response.Write(Request["p"]); %>&tb=<% Response.Write(Request["tb"]); %>&u=<% Response.Write(Request["u"]); %>&m=<% Response.Write(Request["m"]); %>&t=<% Response.Write(Request["t"]); %>&c=<% Response.Write(Request["c"] != null ? Request["c"] : s_c); %>" method="post" enctype="application/x-www-form-urlencoded">
                    <div frm-obj="rw">
...
<asp:Content ID="main_body_rgt" ContentPlaceHolderID="main_body_rgt" runat="server">
    ...
    <div layout-obj="related-pnl">
        ...
        <div related-pnl-obj="related-photo-preview">
            ...
            %>
            <div related-obj="ftr">
                <div ftr-obj="hdr"><a href="?p=business&s=<% Response.Write(business_user_businesscategory.Increment); %>&u=<% Response.Write(business.Email.ToLower()); %>"><% Response.Write(business.BusinessName); %></a></div>
                <div ftr-obj="rating">
                    <div type="rating-mtr">
                        <div hdr-obj="rating-wrappr">
                            <div wrappr-obj="rating">
